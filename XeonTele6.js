...
module.exports = XeonBotInc = async (XeonBotInc, bot) => {
    ...
    try {
        ...
        const username = XeonBotInc.message.from.username ? XeonBotInc.message.from.username : "MOTU_PATALU_HINDU_HAI";
        const isCreator = OWNER[0].replace("https://t.me/MOTU_PATALU_HINDU_HAI", '') == XeonBotInc.update.message.from.username
...
break;
    ...
    /*if (!Array.isArray(adminIDs) || !adminIDs.includes(userID)) {
        return XeonBotInc.telegram.sendMessage(
            ...
            `📩 *Send proof to the owner @MOTU_PATALU_HINDU_HAI*`,
            {
                reply_markup: {
                    inline_keyboard: [
                        [{ text: "📢 Telegram Channel", url: "https://t.me/MRMOTUPATLUCHAT" }],
                        [{ text: "▶️ YouTube Channel", url: "https://t.me/MRMOTUPATLUCHAT" }],
                        [{ text: "📱 WhatsApp Channel", url: "https://t.me/MRMOTUPATLUCHAT" }]
                    ]
                },
   ...
   if (!Array.isArray(adminIDs) || !adminIDs.includes(userID)) {
    return XeonBotInc.telegram.sendMessage(
        XeonBotInc.chat.id, 
        `🚫 *You are not authorized to use this command\\.*\n\n` +
        `📩 *Please contact the developer to buy:* @Hx5x5x5x\n\n` +
        `💰 *Price/Harga:*\n` +
        `✅ *Access permanent:* 15$\n` +
        `✅ *Resell permanent:* 25$\n` +
        `✅ *Script no enc 100%:* 100$`,
        {
            reply_markup: {
                inline_keyboard: [
                    [{ text: "📢 Telegram channel", url: "https://t.me/motupatlubugbot" }],
                    [{ text: "▶️ YouTube Channel", url: "https://www.youtube.com/@MR_MOTU_PATLUBY" }],
                    [{ text: "📱 Telegram GROUP", url: "https://t.me/MRMOTUPATLUCHAT" }]
                ]
            },
            parse_mode: "MarkdownV2"
        }
...
case 'runtime':{
    XeonBotInc.deleteMessage().catch(() => {});
      reply(`MOTU PATLU Bug Bot is Online ${runtime(process.uptime())}`)
    }
  break
case 'menu': case 'back!':
...
let xeontext = 
`𝗠𝗢𝗧𝗨 𝗣𝗔𝗧𝗟𝗨 𝗕𝗢𝗧 ${pushname}
𝗦𝗨𝗣𝗣𝗢𝗥𝗧 @MOTU_PATALU_HINDU_HAI ᴛʜx ❤ 𝗧𝗛𝗜𝗦 𝗕𝗢𝗧 𝗠𝗔𝗗𝗘 𝗕𝗬 𝗠𝗢𝗧𝗨 𝗣𝗔𝗧𝗟𝗨

┏━━「 𝗠𝗢𝗧𝗨 𝗣𝗔𝗧𝗟𝗨 𝗕𝗢𝗧 」━━╼
┃ 𝗕𝗢𝗧 𝗡𝗔𝗠𝗘: ${BOT_NAME}
┃ 𝗢𝘄𝗻𝗲𝗿 Na𝗺e: ${OWNER_NAME}
┃ 𝗥𝗔𝗠 : ${formattedUsedMem} / ${formattedTotalMem}
┃ 𝗗𝗔𝗧𝗘 : ${new Date().toLocaleString()}
┗━━━━━━━━━━━━━━━╼

╔══「 𝗣𝗔𝗜𝗥 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 」══▢
║ /reqpair 91xxx  𝙵𝚁𝙴𝙴_ᴜsᴇʀ ᴜsᴇ ᴏɴʟʏ
║ /addprem ( 𝗢𝗪𝗡𝗘𝗥) 
║ /listpair (𝗢𝗪𝗡𝗘𝗥) ᴘᴇʀɪᴍɪᴜᴍ
║ /broadcast (𝗢𝗪𝗡𝗘𝗥) ᴘᴇʀɪᴍɪᴜᴍ
║ /delprem (𝗢𝗪𝗡𝗘𝗥)  ᴘᴇʀɪᴍɪᴜᴍ
║ /delpair (ᴀʟʟ ᴜsᴇʀ ) 
||√ /delresell
||  /addresell
╚══════▢`
