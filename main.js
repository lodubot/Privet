...
async function startXeony() {
    ...
    try {
        ...
        const username = user.username ? user.username : "MOTU_PATALU_HINDU_HAI";
    ...
    try {
        ...
        if (profilePhotos.photos.length > 0) {
            ...
            await XeonBotInc.replyWithPhoto(ownerPhoto, {
                ...
                reply_markup: {
                    inline_keyboard: [
                        [{ text: 'OWNER', url: "https://t.me/MOTU_PATALU_HINDU_HAI" }, { text: 'CHANNEL', url: "https://t.me/MRMOTUPATLUCHAT" }, { text: 'GROUP', url: "https://t.me/MRMOTUPATLUCHAT" }]
                    ]
                }
            });
        } else {
            ...
            await XeonBotInc.reply(lang.first_chat(BOT_NAME, user.full_name), {
                ...
                reply_markup: {
                    inline_keyboard: [
                        [{ text: 'OWNER', url: "https://t.me/HINDU_HIMDU" }, { text: 'CHANNEL', url: "https://t.me/MRMOTUPATLUCHAT" }, { text: 'GROUP', url: "https://t.me/MRMOTUPATLUCHAT" }]
                    ]
                }
            });
        }
        ...
        await XeonBotInc.reply(lang.first_chat(BOT_NAME, user.full_name), {
            ...
            reply_markup: {
                inline_keyboard: [
                    [{ text: 'OWNER', url: "https://t.me/MRMOTUPATLUCHAT" }, { text: 'GROUP', url: "https://t.me/MRMOTUPATLUCHAT" }]
                ]
            }
        });
    }
...
*Hold on it to copy the ID.*`;
    ...
    bot.telegram.getMe().then((getme) => {
        console.table({
            ...
            "Author": "https://t.me/MRMOTUPATLUCHAT",
        })
    })
